...
namespace Mvis.Plugin.SandboxToPanel.RulesetComponents.Screens.Visualizer.Components.Visualizers
{
    public abstract partial class LinearMusicVisualizerDrawable : MusicVisualizerDrawable
    {
        ...
        protected abstract partial class LinearVisualizerDrawNode : VisualizerDrawNode
        {
